...
type Includes<T extends readonly any[], U> = { [key in keyof T]: Equal<T[key], U>}[number] extends false ? false : true 

/* _____________ Test Cases _____________ */

import type { Equal, Expect } from '@type-challenges/utils'

type test1 = Includes<[{}], { a: 'A' }>;
type test2 = boolean extends false ? true : false;
type test3 = Includes<['Kars', 'Esidisi', 'Wamuu', 'Santana'], 'Kars'>
